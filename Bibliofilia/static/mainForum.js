            ...
            <tr class="TableContent" >
                <td onclick="window.location='forum/${forum.pk}/';" class="col-md-9 ">
                    <div class="d-flex flex-column">
                        ...
                        <p class="cutText">${forum.fields.username} posted on ${forum.fields.dateOfPosting}</p>
                        <p class="cutText">${forum.fields.forumsDescription}</p>
                        <p class="cutText">${forum.fields.userReview}</p>
                    </div>
                </td>
